...
# >>> lista
# [1, 2, 3, 4, 5, 6]
print(f'\n1- Escreva uma funcao que receba uma lista e retorne lista unica e print da soma dos elementos:')
def nested_sum(lista):
    new_lista = []
    for i in lista:
        new_lista.extend(i)
    print(f'A soma dos elementos da lista é: {sum(new_lista)}') 
    return new_lista
...
print(f'\n2- Escreva uma funcao que transforme em string as listas:')
def string_list(lista):
    string = ';'.join(lista)+'\n' 
    return string
...
indice = string_list(lista_cadastro)
cad1 = string_list(lista_cadastrados)
cad2 = string_list(lista_cadastrados1)

print(f'{indice}{cad1}{cad2}')


# 3) Com as seguintes lista, transforme em uma string para poder gravar (futuramente) em um arquivo!
print(f'\n3- Escreva uma funcao que transforme em string as listas com indices:')
def string_indice(lista):
    string = []
    for i in lista:
...
lista_string = string_indice(lista_cadastros)
print(lista_string)
print(type(lista_string))


# 4) Crie uma função que solicite 5 nomes e retorne uma lista com todos eles
print(f'\n4- Escreva uma funcao que solicite 5 nomes e retorne uma lista com eles:')
def five_name():
    lista_name = []
    for i in range(5):
        a = input(f'Digite o {i+1}° nome: ')
        lista_name.append(a)
    return lista_name
lista_name = five_name()
print(lista_name)
...
print(f'\n5- Copie a lista anterior e adicione nomes diferentes em cada sem repetir:')

nomes2 = lista_name.copy()
lista_name.append('Pedro Paulada')
nomes2.append('Paulo Cacetada')
print(f'Lista nomes1: {lista_name}\nLista nomes2: {nomes2}')
