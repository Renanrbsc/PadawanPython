Um sapo pequeno quer chegar ao outro lado da estrada. O sapo está atualmente localizado na posição X e deseja chegar a uma posição maior ou igual a Y. O sapo pequeno sempre pula uma distância fixa, D.
